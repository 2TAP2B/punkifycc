...
const config: SiteConfig = {
  ...
  site: 'https://why.punkify.cc',
  // The name of your site, used in the title and for SEO.
  title: 'why punkify',
  // The description of your site, used for SEO and RSS feed.
  description:
    'punkify is my own private streaming platform running in my homelab. It is built with open source software and is designed to be a more privacy-focused alternative to mainstream streaming services.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Tobi',
  // Keywords for SEO, used in the meta tags.
  tags: ['punkify', 'music', 'streaming', 'selfhosting', 'stelcodes'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/2TAP2B/punkifycc',
      external: true,
    },
  ],
